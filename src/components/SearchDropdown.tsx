...
export function SearchDropdown({ query, onSelect }: SearchDropdownProps) {
  ...
  const allLinks = [
    ...
    { path: '/admin-questionnaires', label: 'Admin/Clinic Questionnaires', sub: 'Reusable admin & clinic documents', icon: LayoutTemplate, color: 'text-amber-700', bg: 'bg-amber-100', permission: 'clinician_forms' },
  ];
