...
export function SearchDropdown({ query, onSelect }: SearchDropdownProps) {
  ...
  const allLinks = [
    ...
    { path: '/admin-questionnaires', label: 'Clinic Admin', sub: 'Reusable clinic documents', icon: LayoutTemplate, color: 'text-amber-700', bg: 'bg-amber-100', permission: 'clinician_forms' },
  ];
