...
import { ClientCsvImportControl } from '../components/clients/ClientCsvImportControl';
type ClientRow = {
  id: string;
  name: string;
  email: string;
  ...
  return <div className="space-y-6 animate-in fade-in duration-500">
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      <div className="flex items-center gap-2">
        <ClientCsvImportControl
          existingEmails={existingClientEmails}
          isImporting={isImportingClients}
          onImportClients={async (clients) => bulkImportClients({ clients }).unwrap()}
          onImported={refetch}
        />
