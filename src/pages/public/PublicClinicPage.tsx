            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm font-semibold text-slate-800 truncate">
                  {item.value && item.value !== "-" && item.value !== "Not provided" ? item.value : "N/A"}
                </p>
              </div>
            </div>
          ))}
      ...
      <section id="clinicians" className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 mt-3 max-w-xl mx-auto">
            Each specialist brings deep expertise and genuine compassion. Click
            a clinician to view availability and book.
          </p>
        </div>
